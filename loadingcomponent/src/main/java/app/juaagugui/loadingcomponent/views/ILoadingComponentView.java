...
public interface ILoadingComponentView {
     ...
     *
     * @param phase       Name of the added phase
     * @param listImages  List of resources (drawable id's) for each frame of the phase
     * @param loadingText Message for the added phase
     * @param progress    Percentage of the added phase
     */
    ...
    /**
     * @param isBlockingMode if isBlockingMode = true, next phase must wait for the previous
     *                       phases to begin.
     */
