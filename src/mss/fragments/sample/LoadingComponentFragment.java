...
import mss.loadingComponentView.listeners.ILoadingComponentViewHandler;
import mss.loadingComponentView.listeners.LoadingComponentViewHandler;
import mss.loadingComponentView.views.LoadingComponentView;
	...
	private class LongTaskSampleSimulator {
		...
		public void task1() {
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					context.updateProgressBar(LoadingComponentFragment.PHASES.P1.toString(), "Running phase 2", 20);
					task2();
				}
			}, 1000);
		}
		...
		public void task2() {
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					context.updateProgressBar(LoadingComponentFragment.PHASES.P2.toString(), "Running phase 3", 40);
					task3();
				}
			}, 1500);
		}
		...
		public void task3() {
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					context.updateProgressBar(LoadingComponentFragment.PHASES.P3.toString(), "Running phase 4", 60);
					task4();
				}
			}, 1500);
		}
		...
		public void task4() {
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					context.updateProgressBar(LoadingComponentFragment.PHASES.P4.toString(), "Running phase 5", 80);
					task5();
				}
			}, 1500);
		}
